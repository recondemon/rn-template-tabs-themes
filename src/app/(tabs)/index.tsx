...
import { ThemeType, useThemeSwitcher } from "@/src/context/ThemeContext";
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        This is a template React Native app using TypeScript with bottom tab
        navigation and support for dynamic theme switching. Select a theme from
        the dropdown and press "Set Theme" to apply it across the app.
      </Text>
